...
** Set school's graduation rate to 100 so it makes sense. **
...
There is no perfect way to evaluate clustering if you don't have the labels, however for this data, we have the labels, so we take advantage of this to evaluate our clusters.

** A new column for df called 'Cluster', which is a 1 for a Private school, and a 0 for a public school.**
...
This is not so bad considering the algorithm purely uses the features to cluster the universities into 2 distinct groups.
